<template>
  <div>
    <div class="container mx-auto">
      <div class="mx-32">
        <div class="flex flex-wrap mb-12 space-x-4 justify-center">
          <!-- card 1 -->
          <div class="bg-white w-96 h-96 cursor-pointer pb-6">
            ...
            <p class="pt-2">
              <button class="form-color py-2 px-16 p rounded text-xl font-bold text-white">Help Now</button>
            </p>
          </div>
          <!-- card 2 -->
          <div class="bg-white w-96 h-96 cursor-pointer pb-6">
